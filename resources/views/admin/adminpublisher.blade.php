@section('title', 'Admin Publisher Books')
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight flex justify-between items-center">
            ...
            <a href="{{ route('publisher.create') }}"
                ...
                <p class="text-sm font-medium leading-none text-white">Add Publisher</p>
            </a>
        </h2>
    </x-slot>
                                ...
                                @forelse ($publishers as $publisher)
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ url('/edit-publisher/' . $publisher->id) }}"
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <form action="{{ url('delete-publisher/' . $publisher->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
