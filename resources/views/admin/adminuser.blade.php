                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500 text-center">
                                            @if ($usertype->usertype === 'admin')
                                                <span class="px-3 py-1 font-semibold rounded-md bg-blue-400 text-white">
                                                    <span>{{ $usertype->usertype }}</span>
                                                </span>
                                            @else
                                                <span
                                                    class="px-3 py-1 font-semibold rounded-md bg-green-400 text-white">
                                                    <span>{{ $usertype->usertype }}</span>
                                                </span>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ url('/edit-user/' . $usertype->id) }}"
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <form action="{{ url('delete-user/' . $usertype->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button
