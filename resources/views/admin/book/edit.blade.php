@section('title', 'Librify - Edit Book')
<x-app-layout>
    <x-slot name="header">
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div class="md:col-span-5">
                                        ...
                                        <textarea name="small_description" id="small_description" class="border mt-1 rounded px-4 w-full bg-gray-50"
                                            rows="4" value="old('small_description')">{{ $book->small_description }}</textarea>
                                    </div>
                                    <div class="md:col-span-5">
                                        <label for="abstract" :value="__('Abstract')">Abstract</label>
                                        <textarea name="abstract" id="abstract" class="border mt-1 rounded px-4 w-full bg-gray-50" rows="15"> {{ $book->abstract }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div class="md:col-span-2 flex items-center">
                                        ...
                                        <input type="checkbox" name="trending" id="trending"
                                            class="h-5 w-5 ml-2 border rounded bg-gray-50"
                                            {{ $book->trending == '1' ? 'checked' : '' }} />
                                    </div>
                                    ...
                                    <div class="md:col-span-1 text-right">
                                        <div class="inline-flex items-end">
                                            <button
                                                ...
                                                <p class="text-sm font-medium leading-none text-white">Update Book</p>
                                            </button>
                                        </div>
                                    </div>
                                </div>
