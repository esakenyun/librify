@section('title', 'Librify - Add File Book')
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="container max-w-screen-lg mx-auto lg:mt-4">
        <div>
            <form action="{{ url('/bookfile/create') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="md:col-span-5 text-right">
                                    <div class="inline-flex items-end">
                                        <button
                                            ...
                                            <p class="text-sm font-medium leading-none text-white">Save Book File</p>
                                        </button>
                                    </div>
                                </div>
                            </div>
